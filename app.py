...
class RepositorioDatosFIEE:
    ...
    def _inicializar_entorno(self) -> None:
        # AQUÍ SE CREA LA CARPETA
        for directorio in ["evidencias", "static", "static/js"]: 
...
# ==========================================
# 5. INICIALIZACIÓN (BOOTSTRAPPING CORRECTO)
# ==========================================
# PRIMERO: Instanciar clases de datos (Esto crea las carpetas físicamente)
...
# ==========================================
# 6. ENRUTADOR PRINCIPAL HTTP (REST API)
# ==========================================
